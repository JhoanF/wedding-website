...
function classic_wedding_custom_styles($custom) {
	//Fonts
	...
	wp_add_inline_style( 'classic-wedding-basic-style', $custom );
}
add_action( 'wp_enqueue_scripts', 'classic_wedding_custom_styles' );

//Sanitizes Fonts
function classic_wedding_sanitize_fonts( $input ) {
	$valid = array(
